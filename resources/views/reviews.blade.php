  ...
  <div class="container">
    ...
    <div class="about-page title-header">
      <div id="heading" class="title">
        <h1>Discounted Wheel Warehouse Reviews</h1>
      </div>
    </div>
    ...
    <div class="row main-contact-2">      
        <div class="col-sm-6">
          <div class="contact-head">
                <div class="contacttablecell"><img src="{{asset('/image/ReviewsandInformation.jpg')}}" class="review-img" ></div>

            <p>Discounted Wheel Warehouse offers Reviews and Information on its sister websites listed below.</p>
            <p>There is a wealth of information and reviews about Discounted Wheel Warehouse. Reviews are an important part of Discounted Wheel Warehouse and we strive to get our customers the best service we possibly can.</p>
            <p>Customer Service is number one at Discounted wheel Warehouse, if your having a problem or wish to submit a review please use the form at the bottom of the page.</p>
      ...
      <div class="col-sm-6 cont-form">
        ...
        <form id="review-form" action="{{url('/review')}}" method="post">
            {{@csrf_field()}}
            ...
            <div class="controls col-md-12">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="form_fname" type="text" name="firstname" class="form-control" placeholder="Please enter your firstname *" required="required" data-error="First Name is required."  value="{{old('firstname')}}">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="form_lname" type="text" name="lastname" class="form-control" placeholder="Please enter your lastname *" required="required" data-error="Last Name is required."  value="{{old('lastname')}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="form_confirmemail">Confirm Email *</label>
                            <input id="form_confirmemail" type="email" name="email_confirmation" class="form-control" placeholder="Please enter your email again *" required="required" data-error="Valid email is required." value="{{old('confirm_email')}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input id="form_phone" type="text" name="phone" class="form-control" placeholder="Please enter your phone number *" required="required" data-error="Phone number is required."  value="{{old('phone')}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="form_invoice">Invoice Number *</label>
                            <input id="form_invoice" type="text" name="invoice" class="form-control" placeholder="Please enter your invoice number *" required="required" data-error="Invoice Number is required." value="{{old('invoice')}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="form_comments" name="comments" class="form-control" placeholder="Comments for us *" rows="4" required="required" data-error="Please, leave us a comments.">{{old('comments')}}</textarea>
                    <div class="help-block with-errors"></div>
                </div>
                <input type="submit" class="btn btn-success checkout-btn btn-send" value="Send Comments">
            </div>
        </form>
      </div>
