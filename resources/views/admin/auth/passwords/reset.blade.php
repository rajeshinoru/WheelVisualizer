        ...
        <div class="col-md-12 login-page">
            <div class="text-center"><a href="{{url('login')}}">
              <img src="{{url(Setting::get('site_logo','/admin/img/logo/logo.png'))}}" class="main-logo">
                    ...
                    <form class="loginSectionform" method="POST" action="{{ route('admin.password.update') }}">
                        @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>
                            ...
                            <input type="email" class="input" name="email" required value="{{ $email ?? old('email') }}" autocomplete="email" autofocus >
                            <div class="line-box">
                                <div class="line"></div>
                            </div>
                        </label>
                    ...
                    <div class="form-group">
                        <label>
                            <p class="label-txt">{{ __('Confirm Password') }}</p>
