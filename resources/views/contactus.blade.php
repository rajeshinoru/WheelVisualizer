        ...
        <div align="center">
            <div class="h2-layout">
                <div id="h2-div1" class="h2-cell">
                    <h1 class="h1-nl">
                        Discounted Wheel Warehouse Contact us
                    </h1>
                </div>
            </div>
            <hr>
    ...
    <div class="row">
        ...
        <div align="center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contacttablecell"><img src="{{asset('/image/Contact-3.png')}}" class="ri" width="367" height="164"></div>
                </div>
            </div>

            <div class="row">
                <div class="col-lg-6">
                    <div class="contacttablecell prod-heading-bold">
                        <h3>Hours of Operation<br>Discounted Wheel Warehouse<br>Pacific Standard Time</h3>
                        <p><b>Monday</b>: 8:00am to 5:00pm<br><b>Tuesday</b>: 8:00am to 5:00pm<br><b>Wednesday</b>: 8:00am to 5:00pm<br><b>Thursday</b>: 8:00am to 5:00pm<br><b>Friday</b>: 8:00am to 5:00pm<br><b>Saturday</b>: 8:00am to 3:00pm <br><br><strong>Our hours of operation have been changed temporarily, due to recent events</strong></p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="contacttablecell"><img src="{{asset('/image/Contact.png')}}" class="ri" width="367" height="229"></div>
                </div>
            </div>
        </div>
    </div>
