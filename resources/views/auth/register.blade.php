      ...
      <div class="col-md-12 register-page">
          ...
          <form class="loginSectionform" action="{{url('register')}}" method="POST">
            {{csrf_field()}}
              ...
              <div class="form-group">
                  <label>
                      <p class="label-txt">@lang('user.register.password_confirmation')</p>
              ...
              <input type="checkbox" name="i_agree" value="Wheel"> @lang('user.register.i_agree')
              </div>--}}
              <div class="form-group text-center">
                  <button type="submit" class="btn submitBtn" data-toggle="modal" data-target="#exampleModal"> @lang('user.register.register')</button>
              </div>
          </form>
          <p class="dontHave"> @lang('user.register.have_account') <a href="login"> @lang('user.login.login')</a></p>
