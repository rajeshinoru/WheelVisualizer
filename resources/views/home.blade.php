                ...
                <div class="slideshow-panel col-sm-12">
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <ol class="carousel-indicators">
                            @foreach(getSliders('Home') as $skey => $slider)
                            <li data-target="#carousel-example-generic" data-slide-to="{{$skey}}" class="{{($skey == 0)?'active':''}}"></li>
                            @endforeach 
                        </ol>
                        <!-- Wrapper for slides -->
                        <div class="carousel-inner">
                            ...
                            @foreach(getSliders('Home') as $skey => $slider)
                                <div class="item {{($skey == 0)?'active':''}}">
                                <a href="{{@$slider->redirectlink?url(@$slider->redirectlink):''}}" target="_blank"> 
                                    <img src="{{asset('/storage/'.$slider->image)}}" alt="Wheel">
                                    <!-- Static Header -->
                                    <div class="header-text hidden-xs">
                                        <div class="col-md-12 text-center">
                                            <h2><strong>{{$slider->title}}</strong></h2>
                                            <br>
                                            <h3><span>{{$slider->description}}</span></h3>
                                            <br>
                                            <!-- <div class="">
                                                <a class="btn btn-theme btn-sm btn-min-block" href="#">CONTACT US</a><a class="btn btn-theme btn-sm btn-min-block" href="#">READ MORE</a>
                                            </div> -->
                                        </div>
                                    </div>
                            </a>
