                    ...
                    <div class="asset-inner"  style="min-height: 680px;">
                        <table class="table"> 
                            ...
                            <tr>
                                ...
                                <td class="{{($message->postby == 'user')?'right-text':''}}">
                                    <p>
                            ...
                            <tr>
                                <td>
                                        <form action="{{route('ticket.message.store')}}"   method="POST"  enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            <input type="hidden" name="ticket_id" value="{{$ticket->id}}">
                                            <input type="hidden" name="postby" value="user">
                                            <div class="row">
