  ...
  <div class="container">
    ...
    <div class="about-page title-header">
      <div id="heading" class="title">
        <h1>Feedback - Discounted Wheel Warehouse</h1>
      </div>
    </div>
    ...
    <div class="row main-contact-2">      
      ...
      <div class="col-sm-6 cont-form">
        ...
        <form id="review-form" action="{{url('/feedback')}}" method="post">
            {{@csrf_field()}}
            ...
            <div class="controls col-md-12">
                ...
                <input type="submit" class="btn btn-success checkout-btn btn-send" value="Send Feedback">
            </div>
        </form>
      </div>
