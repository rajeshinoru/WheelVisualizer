...
<section id="contact-us" class="contact-page">
    <div class="container">
        ...
        <div class="about-page title-header">
            <div id="heading" class="title">
                <h4>Fast Shipping on all Wheel and Tire Packages and Wheel Orders</h4>
            </div>
        </div>
            <br>
<p>Fast Shipping on all Wheel and Tire Packages to the Continental United States.</p>

<p>Fast Shipping on all Wheel Orders to the Continental United States.</p>

<p>For Tires only orders, there is a Shipping Quote button on the right side of the product window to get a quote for shipping prices.</p>

<p>Fedex is our Primary Shipper the map below shows Fedex Ground Shipping times from our primary facility.</p>
                </div>
            </div>
